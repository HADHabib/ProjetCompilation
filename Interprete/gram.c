...
{
  "\"end of file\"", "error", "\"invalid token\"", "OP0", "OP1", "OP2",
  "OPS", "OPL", "OPC", "INT", "NAME", "LABEL", "STRING", "EOL", "BREAK",
  "','", "$accept", "prog", "linstr", "inst", "pre", "break", "label", YY_NULLPTR
};
